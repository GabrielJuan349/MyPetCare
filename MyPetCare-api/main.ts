...
import {
  ...
  getPetsByOwner,
  updatePet,
} from './api-functions/pet-request.ts';
import {
  createPrescription,
  deletePrescription,
  getPrescription,
  getPrescriptionByPet,
  updatePrescription,
} from './api-functions/prescription.ts';
import { createClinic, deleteClinic, getAllClinics, getClinics } from './api-functions/clinics.ts';
import { createVet, deleteVet, getVetById, getVetsByClinic } from './api-functions/vets.ts';
import { createNews, deleteNews, getAllNews } from './api-functions/news.ts';
import { deleteUser, getUserDataById, updateUser } from './api-functions/gestion.usuarios.ts';
import { monthBlockedRequest } from './api-functions/blocked-request.ts';
import {
  deleteAppointment,
  getAllAppointmentsFromOwner,
  getAppointmentById,
  getCitasByVetId,
  newAppointment,
} from './api-functions/appointments.ts';
import {
  createReport,
  deleteReport,
  getReportById,
...
import { createVaccine, getVaccineByPetID } from './api-functions/vaccines.ts';
import {
  createAdoption,
  deleteAdoption,
  getAdoptionById,
...
router
  ...
  .post('/api/calendar/:id', monthBlockedRequest)
  // GET dates from vetId
  .get('/api/appointment/vet/:vetId', getCitasByVetId)
