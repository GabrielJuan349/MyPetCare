...
class _EditPetState extends State<EditPet> {
  ...
  Widget _buildTextField(String label, {bool obscureText = false}) {
    ...
    if (label == "Name") {
      ...
      _textController = _textControllerAge;
    } else if (label == "Breed") {
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            myPet.age = _textControllerAge.text;
            myPet.breed = _textControllerBreed.text;
            myPet.weight = _textControllerWeight.text;
            /*
            setState(() {
              //myPet = updatedPet;
